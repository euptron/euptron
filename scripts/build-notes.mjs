#!/usr/bin/env node
// Zero-dependency compiler for the EUPTRON notes pipeline.
...
// emits a single notes.json consumed by euptron.pages.dev.
//
// Usage: node scripts/build-notes.mjs
// Env:   NOTES_DIR (default "notes"), OUT_PATH (default "dist/notes.json")
...
writeFileSync(OUT_PATH, JSON.stringify({ generated_at: new Date().toISOString(), count: posts.length, posts }, null, 2) + '\n');
